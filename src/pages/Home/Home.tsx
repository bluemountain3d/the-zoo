          ...
          <Link to={`/animal/${animal.id}` } key={animal.id}>
            <article className="featured-animal">
              ...
              <hgroup className="featured-animal__heading heading-group-sm">
                <h3 className="featured-animal__title heading-group__title">{animal.name}</h3>
                <p className="featured-animal__subtitle heading-group__subtitle">({animal.latinName})</p>
              </hgroup>
            </article>
          </Link>
        ))}
